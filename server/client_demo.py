...
if __name__ == '__main__':
    ...
    # print(conn.recv())
    # # put file
    # conn.send(b'{"op": "put-file", "id": "jinyi.xia@bupt.edu.cn", "path": "./test.mp4"}')
    # assert conn.recv() == b'200'
    # conn.send(b'200')
    # assert conn.recv() == b'200'
    # with open('/Users/xjy/Desktop/video.mp4', 'rb') as f:
    #     file = f.read()
    # conn.send(file)
    # print(conn.recv())
    # # get dir list
    ...
    # print(conn.recv())
    # # get file
    # conn.send(b'{"op": "get-file", "id": "jinyi.xia@bupt.edu.cn", "path": "./test.mp4"}')
